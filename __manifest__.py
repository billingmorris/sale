...
- Editar la cantidad y el precio unitario de cada producto, con
  cálculo automático de subtotal y total.
- Al confirmar, se crea una cotización (sale.order) en estado borrador
  con los productos, cantidades y precios definidos en el wizard.
- El resto de la información (cliente adicional, condiciones, etc.) se
